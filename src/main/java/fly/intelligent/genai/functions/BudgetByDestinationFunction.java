...
public class BudgetByDestinationFunction implements Function<BudgetByDestinationFunction.DestinationBudgetRequest,
        BudgetByDestinationFunction.DestinationBudgetResponse> {
    @Override
